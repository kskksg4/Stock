...
class DetailViewModel(private val storeImageAdapter: StoreImageAdapter, private val api: JSONApi) : BaseViewModel() {
    ...
    val items: LiveData<List<DetailImageBean>> get() = _img_arr
